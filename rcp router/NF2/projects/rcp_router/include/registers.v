...
`define RCP_BLOCK_ADDR_WIDTH            18
`define RCP_REG_ADDR_WIDTH              5
...
`define RCP_BLOCK_ADDR            18'h00006
...
`define RCP_RATE_0              5'h0
`define RCP_RATE_1              5'h1
`define RCP_RATE_2              5'h2
`define RCP_RATE_3              5'h3
`define RCP_MAC_0_RTT_HI        5'h4
`define RCP_MAC_0_RTT_LO        5'h5
`define RCP_MAC_0_NUM_RCP       5'h6
`define RCP_MAC_0_NUM_BYTES_HI  5'h7
`define RCP_MAC_0_NUM_BYTES_LO  5'h8
`define RCP_MAC_1_RTT_HI        5'h9
`define RCP_MAC_1_RTT_LO        5'ha
`define RCP_MAC_1_NUM_RCP       5'hb
`define RCP_MAC_1_NUM_BYTES_HI  5'hc
`define RCP_MAC_1_NUM_BYTES_LO  5'hd
`define RCP_MAC_2_RTT_HI        5'he
`define RCP_MAC_2_RTT_LO        5'hf
`define RCP_MAC_2_NUM_RCP       5'h10
`define RCP_MAC_2_NUM_BYTES_HI  5'h11
`define RCP_MAC_2_NUM_BYTES_LO  5'h12
`define RCP_MAC_3_RTT_HI        5'h13
`define RCP_MAC_3_RTT_LO        5'h14
`define RCP_MAC_3_NUM_RCP       5'h15
`define RCP_MAC_3_NUM_BYTES_HI  5'h16
`define RCP_MAC_3_NUM_BYTES_LO  5'h17
