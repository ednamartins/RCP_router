...
#define RCP_RATE_0_REG                          0x2000808
#define RCP_RATE_1_REG                          0x200080c
#define RCP_RATE_2_REG                          0x2000810
#define RCP_RATE_3_REG                          0x2000814
#define RCP_MAC_0_RTT_L_REG                     0x2000818
#define RCP_MAC_0_RTT_H_REG                     0x200081c
#define RCP_MAC_0_NUM_RCP_REG                   0x2000820
#define RCP_MAC_0_NUM_BYTE_L_REG                0x2000824
#define RCP_MAC_0_NUM_BYTE_H_REG                0x2000828
#define RCP_MAC_1_RTT_L_REG                     0x200082c
#define RCP_MAC_1_RTT_H_REG                     0x2000830
#define RCP_MAC_1_NUM_RCP_REG                   0x2000834
#define RCP_MAC_1_NUM_BYTE_L_REG                0x2000838
#define RCP_MAC_1_NUM_BYTE_H_REG                0x200083c
#define RCP_MAC_2_RTT_L_REG                     0x2000840
#define RCP_MAC_2_RTT_H_REG                     0x2000844
#define RCP_MAC_2_NUM_RCP_REG                   0x2000848
#define RCP_MAC_2_NUM_BYTE_L_REG                0x200084c
#define RCP_MAC_2_NUM_BYTE_H_REG                0x2000850
#define RCP_MAC_3_RTT_L_REG                     0x2000854
#define RCP_MAC_3_RTT_H_REG                     0x2000858
#define RCP_MAC_3_NUM_RCP_REG                   0x200085c
...
#define DECAP_NUM_WORD_IN_REG                   0x2000a10
#define DECAP_NUM_WORD_OUT_REG                  0x2000a14
#define DECAP_VALID_TUNNELING_REG               0x2000a18
#define DECAP_USER_DATA_PATH_HEADER_REG         0x2000a1c
#define DECAP_NUM_PACKET_IN_REG                 0x2000a20
#define DECAP_NUM_PACKET_OUT_REG                0x2000a24
#define ENCAP_NUM_PACKET_IN_REG                   0x2000924

#define ENCAP_NUM_PACKET_OUT_REG                   0x2000928

#define ENCAP_NUM_BYTES_IN_REG                 0x200092c

#define ENCAP_NUM_BYTES_OUT_REG                 0x2000930

#define ENCAP_ENABLE_REG                        0x2000908

#define ENCAP_IP_DATA_0_REG                     0x200090c

#define ENCAP_IP_DATA_1_REG                     0x2000910

#define ENCAP_IP_DATA_2_REG                     0x2000914

#define ENCAP_IP_DATA_3_REG                     0x2000918

#define ENCAP_IP_DATA_4_REG                     0x200091c

#define ENCAP_IP_DATA_5_REG                     0x2000920
